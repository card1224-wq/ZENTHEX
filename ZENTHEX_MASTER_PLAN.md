...
- `GEMINI_API_KEY`가 설정되어 있으면 Gemini NanoBanana(`gemini-2.5-flash-image`)로 프롬프트 이미지를 즉시 생성해 Studio 화면에 먼저 보여줍니다.
...
- 상단 요약: 매도 방식, 목표 수익률, 투자금 방식, 코인 선택 방식
- 기본 설정: 코인 선택, 목표 수익률, 투자금 방식만 먼저 노출
- 고급 설정: 추적익절, 고점 대비 하락폭, 보유 코인 정리 후 재진입, 위험 설명은 접힌 패널 안에서 필요할 때만 조정
